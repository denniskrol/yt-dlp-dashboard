            ...
            @if ($selectedPreset == 'custom')
                <div class="flex flex-row pb-2">
                    <div class="basis-6/12 mr-2">
                        ...
                        <select id="format" name="format" class="w-full p-2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-xs" wire:model="quality">
